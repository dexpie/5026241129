@extends('template2')
@section('title', 'PR 3 - Tambah Nilai Kuliah')
@section('konten')

    <h2 class="mt-3">Tambah Data Nilai Kuliah</h2>
    ...
    <form action="{{ route('nilaikuliah.store') }}" method="POST" onsubmit="return validasiNilaiKuliah()">
        @csrf

        <div class="mb-3">
            <label for="NRP" class="form-label">NRP</label>
            <input type="text" name="NRP" id="NRP" class="form-control" maxlength="6" value="{{ old('NRP') }}">
        </div>
